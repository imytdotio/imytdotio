...
// }
const nav =
  "bg-white shadow-xl xl:p-3 p-2 m-1 text-xl rounded-xl lg:p-4 text-2xl border-white border-2 duration-100 hover:border-black hover:bg-gray-200 hover:border-2";

const active =
  "bg-gray-300 shadow-xl xl:p-3 p-2 m-1 text-xl rounded-xl lg:p-4 text-2xl border-gray-900 border-2 duration-100";
